(function(angular) {
    ...
    function AppearanceCtrl(dataService, i18n) {
        ...
        function setTheme() {
            document.documentElement.style.setProperty('primary_bg', document.documentElement.style.valueOf('--preview_primary_bg'));
            document.documentElement.style.setProperty('primary_text', document.documentElement.style.valueOf('--preview_primary_text'));
            document.documentElement.style.setProperty('primary_hover', document.documentElement.style.valueOf('--preview_primary_hover'));
            document.documentElement.style.setProperty('primary_active', document.documentElement.style.valueOf('--preview_primary_active'));
            document.documentElement.style.setProperty('accent_bg', document.documentElement.style.valueOf('--preview_accent_bg'));
            document.documentElement.style.setProperty('accent_text', document.documentElement.style.valueOf('--preview_accent_text'));
            document.documentElement.style.setProperty('accent_hover', document.documentElement.style.valueOf('--preview_accent_hover'));
            document.documentElement.style.setProperty('accent_active', document.documentElement.style.valueOf('--preview_accent_active'));
            document.documentElement.style.setProperty('item_bg', document.documentElement.style.valueOf('--preview_item_bg'));
            document.documentElement.style.setProperty('item_text', document.documentElement.style.valueOf('--preview_item_text'));
            document.documentElement.style.setProperty('item_hover', document.documentElement.style.valueOf('--preview_item_hover'));
            document.documentElement.style.setProperty('item_active', document.documentElement.style.valueOf('--preview_item_active'));
            document.documentElement.style.setProperty('bar_bg', document.documentElement.style.valueOf('--preview_bar_bg'));
            document.documentElement.style.setProperty('bar_text', document.documentElement.style.valueOf('--preview_bar_text'));
            document.documentElement.style.setProperty('bar_hover', document.documentElement.style.valueOf('--preview_bar_hover'));
            document.documentElement.style.setProperty('bar_active', document.documentElement.style.valueOf('--preview_bar_active'));
            document.documentElement.style.setProperty('secondary_bg', document.documentElement.style.valueOf('--preview_secondary_bg'));
        }
